...
def fakeEmail():
  ...
  print ('')
  data_kytu = ['', '_', '.']
  so_luong = int(input(" \033[1;36m Nhập Số Lượng : "))
  Domain = input(" \033[1;37mNhập Domain(ex: yahoo) : ")
  file_email = input(" \033[1;34m Nhập File Lưu Mail(ex: phucthinh.txt) : ")
  n = 0
  for fake in range(so_luong):
    ...
    print (" [" + str(n) + "] |ThinhDz|" + fake_email)
...
def checkhotmail():
  ...
  try:
    ...
    hotmail = open(input(" \033[1;34m Nhập File Chứa Hotmail(ex: phucthinh.txt) : ")).readlines()
    hotmail_die = input(" \033[1;34m Nhập File Lưu Hotmail Die(phucthinh1.txt) : ")
    hotmail_live = input(" \033[1;34m Nhập File Lưu Hotmail Live(phucthinh2.txt) : ")
  except:
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print (" \033[1;31m |\033[1;37mThinhDz\033[1;31m|Email Live|" + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print (" \033[1;32m |\033[1;37mThinhDz\033[1;32m|Email Die|" + hot_mail + "@hotmail.com")
...
def checkyahoo():
  ...
  try:
    print (" \033[1;34m CÓ THỂ NHẬP ĐỊNH DẠNG MAIL|PASS")
    n_yahoo = 0
    yahoo = open(input(" \033[1;34m Nhập File Chứa Yahoo(ex: phucthinh.txt) : ")).readlines()
    yahoo_die = input("  \033[1;34m Nhập File Lưu Yahoo Die(ex: phucthinh1.txt) : ")
    yahoo_live = input(" \033[1;34m Nhập File Lưu Yahoo Live(ex: phucthinh2.txt) : ")
  except:
    print (" \033[1;31mKHÔNG TÌM THẤY FILE BẠN ĐÃ NHẬP !")
    quit()
  list_yid = []
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" \033[1;32m |\033[1;37mThinhDz\033[1;32m|Email Die| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(" \033[1;31m |\033[1;37mThinhDz\033[1;31m|Email Live| " + yid + "@yahoo.com")
...
def checkvalid():
  ...
  try:
    ...
    fileEmail = open(input(" \033[1;34m Nhập File Chứa Email(ex: phucthinh.txt) : ")).readlines()
    valid = input(" \033[1;34m Nhập File Lưu Email Valid Facebook(ex: phucthinh1.txt) : ")
  except:
    print (" \033[1;31mKHÔNG TÌM THẤY FILE BẠN ĐÃ NHẬP !")
    quit()
  list_email_fb = []
  ...
  def run_check_valid(emailfb):
    ...
    if kq_check == None:
      print (" \033[1;32m |\033[1;37mThinhDz\033[1;32m| Có Liên Kết |" + emailfb)
      open(valid,"a").write(emailfb + "\n")
    else:
      print (" \033[1;31m |\033[1;37mThinhDz\033[1;31m| Không Liên Kết |" + emailfb)
  with concurrent.futures.ThreadPoolExecutor() as executor:
...
def logo():
  logo = """
        ...
        \033[1;36m▀▀█▀▀ █▀▀█ █▀▀█ █     \033[1;90m█▀▀ █  █ █▀▀ █▀▀ █  █   \033[1;37m█▀▄▀█ █▀▀█ █ █   \033[1;33m█▀▀█ █  █  █  █ █▀▀   \033[1;32m▀▀█▀▀ █  █ █ █▀▀█ █  █
        \033[1;93m  █   █  █ █  █ █     \033[1;37m█   █▀▀█ █▀▀ █   █▀▀█   \033[1;91m█ ▀ █ █▀▀█ █ █   \033[1;34m█▀▀▀ █▀▀█  █  █ █     \033[1;93m  █   █▀▀█ █ █  █ █▀▀█
        \033[1;36m  ▀   ▀▀▀▀ ▀▀▀▀ ▀▀▀   \033[1;34m▀▀▀ ▀  ▀ ▀▀▀ ▀▀▀ ▀  ▀   \033[1;35m▀   ▀ ▀  ▀ ▀ ▀   \033[1;35m▀    ▀  ▀   ▀▀  ▀▀▀   \033[1;36m  ▀   ▀  ▀ ▀ ▀  ▀ ▀  ▀
                  \033[0;33m Bản Quyền Thuộc Về  : Do Phuc Thinh
                  \033[1;35m Zalo Của Thịnh Nè   : 0587135245
"""
...
def process_menu():
  menu = """
                    ...
                    \033[1;37m Do Phuc Thinh IT 
                      \033[1;36m1. Tool Random Mail.
                      \033[1;32m2. Tool Lọc  Hotmail.
                      \033[1;33m3. Tool Lọc Yahoo.
                      \033[1;34m4. Tool Check Liên Kết Facebook.
                      \033[1;39m5. Thoát Tool Của Thịnh Đẹp Trai.
                \033[1;90m            CHỌN NHANH ĐI CHA NỘI
...
"""
  for letter in menu:
  	...
  	sys.stdout.flush()
  	time.sleep(0.001)
  choice_user = input("\033[1;91m Nhập Lựa Chọn Tại Đây Nè : ")
  if choice_user == '1':
    clear()
    fakeEmail()
  if choice_user == '2':
  ...
  if choice_user == '5':
    clear()
    print (" Zalo 0587135245 nha anh em tui.")
    quit()
